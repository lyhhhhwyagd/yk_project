<template>
  ...
  <div class="create">
      ...
      >
        ...
        <div v-else>
          ...
          <el-input
            type="textarea"
            placeholder="回答"
            style="display: block; width: 1120px; margin:10px 0; padding-right: 400px;"
          >
          </el-input>
        </div>
    ...
    <div style="padding-bottom: 20px">
      ...
      <el-dropdown v-model="dropdownVisible" @command="addQues">
...
export default {
  ...
  methods: {
    ...
    addQues(type) {
      console.log('Selected command:', type);
    ...
    submitpaper: async function() {
      ...
      console.log("发放问卷submitpaper res",res);
      if (res) {
