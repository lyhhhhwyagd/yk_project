...
<template>
   <div  v-if="userRight">
      <div class="card" style="margin-bottom: 10px ;" >
         <div  >
            <el-input style="width: 220px" size="small" v-model="ClassManages.studentName"  placeholder="请输入学生姓名" :prefix-icon="Search"/>
            <el-button type="primary" size="small" style="background-color: rgb(128, 214, 22)" @click="load">查询</el-button>
